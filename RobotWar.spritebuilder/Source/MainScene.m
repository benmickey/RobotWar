...
>>>>>>> e7762f7a2a3100574454f2b4905437b91c30f96c
     ...
     // Robot *robot2 = (Robot*) [[NSClassFromString(robotClass2) alloc] init];
      ...
      robot2.robotClass = robotClass2;
        ...
        robot3.robotNode = [CCBReader load:@"Robot" owner:robot3];
        CGSize screenSize2 = [[CCDirector sharedDirector] viewSize];
        robot3.robotNode.position = ccp(screenSize2.width - 100, 100);
        [self addChild:robot3.robotNode];
        robot3.gameBoard = self;
        [robot3 _run];
